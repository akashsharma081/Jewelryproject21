...
<div class="paira-container">
   <header class="header-fixed">
    ...
    <main class="register-page">
        <section class="register-content paira-gap-2">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 padding-fix-2 paira-gap-3">
                        <form method="post" action="register.html" id="create_customer" accept-charset="UTF-8"><input type="hidden" value="create_customer" name="form_type" /><input type="hidden" name="utf8" value="✓" />
                            <input type="text" value="" name="customer[first_name]" id="first_name" placeholder="First Name" class="form-control margin-bottom-30"  />
                            <input type="text" value="" name="customer[last_name]" id="last_name" class="form-control margin-bottom-30" placeholder="Last Name"  />
                            <input type="email" value="" name="customer[email]" id="email" class="form-control margin-bottom-30" placeholder="Email" />
                            <input type="password" value="" name="customer[password]" id="password" class="form-control margin-bottom-30" placeholder="Password" />
                            <button type="submit" class="btn btn-default margin-right-10 btn-lg pull-left">Submit</button>
                            <a href="login.html" class="margin-top-15 pull-left color-1"><span class="under">Login</span> to an existing account</a>
                        </form>
                    </div>
                </div>
            </div>
