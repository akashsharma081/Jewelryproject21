                    ...
                    <div id="login">
                        ...
                        <div class="col-md-12 padding-fix-2 paira-gap-3">
                            <form method="post" action="login.html" id="customer_login" accept-charset="UTF-8"><input type="hidden" value="customer_login" name="form_type" /><input type="hidden" name="utf8" value="✓" />
                                ...
                                <Link to="/ForgetPassword" class="paira-hide-login  display-inline-b margin-bottom-30"><h5 class="margin-clear">Forgot your password?</h5></Link>
                            </form>
                            <button type="submit" class="btn btn-default btn-lg margin-right-10 margin-bottom-30 pull-left">LogIn</button>
                            <Link to="/Register" class="margin-top-15 pull-left color-1"><span class="under">Register</span> a new account</Link>
                        </div>
                    </div>
                </div>
            </div>
