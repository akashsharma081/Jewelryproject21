            ...
            <section class="blog-content">
                <div class="container-fluid padding-clear">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="row">
                            <article class="col-md-6 col-sm-6 col-xs-12 padding-clear border-bottom border-none">
                                <div class="blog-hover position-r overflow-h img">
                                    <div class="featured-image">
                                        <a href="article.html"><img src="images/IMG_5391.JPG" alt="" class="img-responsive center-block" /></a>
                                    </div>
                                    <div class="blog_info">
                            ...
                            <article class="col-md-6 col-sm-6 col-xs-12 padding-clear border-bottom border-left">
                                <div class="blog-hover position-r overflow-h img">
                                    <div class="featured-image">
                                        <a href="article.html"><img src="images/IMG_5424.JPG" alt="" class="img-responsive center-block" /></a>
                                    </div>
                                    <div class="blog_info">
                                        <h1 class="margin-clear">09</h1>
                                        <p class="margin-clear">Nov 2018</p>
                            ...
                            <article class="col-md-6 col-sm-6 col-xs-12 padding-clear border-bottom border-none">
                                <div class="blog-hover position-r overflow-h img">
                                    <div class="featured-image">
                                        <a href="article.html"><img src="images/IMG_5445.JPG" alt="" class="img-responsive center-block" /></a>
                                    </div>
                                    <div class="blog_info">
                                        <h1 class="margin-clear">09</h1>
                                        <p class="margin-clear">Nov 2018</p>
                            ...
                            <article class="col-md-6 col-sm-6 col-xs-12 padding-clear border-bottom border-left">
                                <div class="blog-hover position-r overflow-h img">
                                    <div class="featured-image">
                                        <a href="article.html"><img src="images/IMG_5311.JPG" alt="" class="img-responsive center-block" /></a>
                                    </div>
                                    <div class="blog_info">
                                        <h1 class="margin-clear">09</h1>
                                        <p class="margin-clear">Nov 2018</p>
                        ...
                        <div class="full-width text-center paira-gap-3 paira-gap-4">
