    ...
    <main class="blog-single-page">
        <section class="blog-single-content">
            <div class="container-fluid padding-clear">
                <h1 class="page-header text-center">All hand bracelet is use cool women</h1>
                <div class="col-md-12 col-sm-12 col-xs-12 padding-clear">
                        <article class="border-bottom paira-gap-4">
                            <ul class="list-inline date-info text-center">
                                <li><h3><span>09,</span> Nov 2018</h3></li>
                                <li><p class="color-fix">by <strong>ThemeTidy</strong></p></li>
                            </ul>
                            <div class="featured-image">
                                <img src="images/article/article.jpg" alt="" class="img-responsive center-block full-width" />
                            </div>
                            <div class="blog-article padding-fix-2 margin-top-40">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12  border-bottom paira-gap-4">
                            <form method="post" action="article.html" id="comment_form" class="comment-form" accept-charset="UTF-8"><input type="hidden" value="new_comment" name="form_type" /><input type="hidden" name="utf8" value="✓" />
                                <div class="blog-post-form padding-fix-2 paira-gap-3">
                        ...
                        <div class="overflow-h padding-fix-2 paira-gap-3 paira-gap-4">
                            <div class="col-lg-12 blog-next-prev">
                                <a href="#" class="pull-left"><img src="images/arrow-left.png" alt="" class="img-responsive"/></a>
                                <a href="#" class="pull-right"><img src="images/arrow-right.png" alt="" class="img-responsive"/></a>
                            </div>
                        </div>
                    </div>
                </div>
