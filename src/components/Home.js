    ...
    <main class="home-page">
                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12 position-r padding-clear">
                                ...
                                <div class="carousel-inner text-uppercase" role="listbox">
                                    <div class="item active">
                                        <img src="images/IMG_5356.JPG" alt=""/>
                                    </div>
                                    <div class="item">
                                        <img src="images/IMG_5324.JPG" alt=""/>
                                    </div>
                                    <div class="item">
                                        <img src="images/IMG_5390.JPG" alt=""/>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-6 col-xs-12 padding-clear border-none mobile-border-bottom">
                            <div class="paira-product product">
                                <a href="product.html">
                                    <img src="images/IMG_5445.JPG" class="img-responsive center-block paira-product-image full-width inactive-product" alt="" />
                                    <img src="images/IMG_5339.JPG " alt="" class="img-responsive center-block paira-product-image full-width product-active" />
                                </a>
                        ...
                        <div class="paira-product product border-left">
                                <a href="product.html">
                                    <img src="images/IMG_5396.JPG" alt="" class="img-responsive center-block paira-product-image full-width inactive-product" />

                                    <img src="images/IMG_5302.JPG" alt="" class="img-responsive center-block paira-product-image full-width product-active" />
                                </a>
            ...
            <section class="border-bottom">
                        <div class="container-fluid">
                            ...
                            <div class="recent-product col-md-6 col-sm-6 col-xs-12 padding-clear">
                                    ...
                                    <div class="carousel-inner" role="listbox">
                                            ...
                                            <div class="paira-product product">
                                                    <a href="product.html">
                                                        <img src="images/IMG_5437.JPG" class="img-responsive center-block paira-product-image full-width inactive-product" alt="" />
                                                        <img src="images/IMG_5311.JPG" alt="" class="img-responsive center-block paira-product-image full-width product-active" />
                                                    </a>
                                                    <div class="product-sale"><span>Sale</span></div>
                                                    <div class="margin-left-10 margin-right-10 product-title-price text-left">
                                            ...
                                            <div class="paira-product product">
                                                    <a href="product.html">
                                                        <img src="images/IMG_5399.JPG" alt="" class="img-responsive center-block paira-product-image full-width inactive-product" />
                                                        <img src="images/IMG_5424.JPG" alt="" class="img-responsive center-block paira-product-image full-width product-active" />
                                                    </a>
                                                    <div class="margin-left-10 margin-right-10 product-title-price text-left">
                                            ...
                                            <div class="item">
                                                <div class="paira-product product">
                                                    <a href="product.html">
                                                        <img src="images/IMG_5393.JPG" alt="" class="img-responsive center-block paira-product-image full-width inactive-product" />
                                                        <img src="images/IMG_5424.JPG" alt="" class="img-responsive center-block paira-product-image full-width product-active" />
                                                    </a>
                                                    <div class="margin-left-10 margin-right-10 product-title-price text-left">
                                            ...
                                            <div class="item">
                                                <div class="paira-product product">
                                                    <a href="product.html">
                                                        <img src="images/IMG_5391.JPG" alt="" class="img-responsive center-block paira-product-image full-width inactive-product" />
                                                        <img src="images/IMG_5441.JPG" alt="" class="img-responsive center-block paira-product-image full-width product-active" />
                                                    </a>
                                                    <div class="margin-left-10 margin-right-10 product-title-price text-left">
                            ...
                            <div class="collection-list col-md-6 col-sm-6 col-xs-12 padding-clear border-left">
                                    <div class="collection-item img overflow-h position-r">
                                        <a href="collection.html" class="collection-img">
                                            <img src="images/IMG_5447.JPG" alt="gem free demo collection 1" class="img-responsive" />
                                        </a>
                                        <div class="collection-inner text-center">
                                            <Link class="btn btn-default btn-lg" to="/Collection">Shop The Collection</Link>
                                        </div>
                                    </div>
                                </div>
                            </div>
             ...
             {/* <section class="video border-bottom position-r">
                <img src="images/IMG_5442.JPG" class="img-responsive" alt="" />
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-6 col-sm-6 col-xs-12 padding-clear ">
                            <div class="blog-hover position-r overflow-h img">
                                <div class="featured-image">
                                    <a href="article.html"><img src="images/IMG_5393.JPG" alt="" class="img-responsive center-block" /></a>
                                </div>
                                <div class="blog_info">
                                    <h1 class="margin-clear">09</h1>
                                    <p class="margin-clear">Nov 2021</p>
                                </div>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12 padding-clear border-left ">
                            <div class="blog-hover position-r overflow-h img">
                                <div class="featured-image">
                                    <a href="article.html"><img src="images/IMG_5310.JPG" alt="" class="img-responsive center-block" /></a>
                                </div>
                                <div class="blog_info">
                                    <h1 class="margin-clear">09</h1>
                                    <p class="margin-clear">Nov 2021</p>
                    ...
                    <div class="row">
                        <div class="banner-slider col-md-6 col-sm-6 col-xs-12 padding-clear overflow-h">
                            <div id="banner-slider" class="carousel slide" data-ride="carousel">
                                <div class="carousel-inner" role="listbox">
                                    <div class="item active">
                                        <a href="#" target="_blank"><img src="images/IMG_5297.JPG" alt="" class="img-responsive center-block" /></a>
                                    ...
                                    <div class="item">
                                        <a href="#" target="_blank"><img src="images/IMG_5389.JPG" alt="" class="img-responsive center-block"/></a>
                                        <div class="banner-content">
                                            <div>
                        ...
                        <div class="gallery col-md-6 col-sm-6 col-xs-12 padding-clear">
                            <div class=" col-md-6 col-sm-6 col-xs-12 padding-clear">
                                <div class="gallery-inner">
                                    <a href="#" class="gallery-img"><img src="images/IMG_5442.JPG" class="img-responsive center-block" alt=""/></a>
                                    <a href="#" class="gallery-link"><i class="fa fa-link fa-2x"></i></a>
                                </div>
                                <div class="gallery-inner">
                                    <a href="#" class="gallery-img"><img src="images/IMG_5296.JPG" class="img-responsive center-block" alt=""/></a>
                                    <a href="#" class="gallery-link"><i class="fa fa-link fa-2x"></i></a>
                                </div>
                            </div>
                            <div class=" col-md-6 col-sm-6 col-xs-12 padding-clear">
                                <div class="gallery-inner">
                                    <a href="#" class="gallery-img"><img src="images/IMG_5399.JPG" class="img-responsive center-block" alt=""/></a>
                                    <a href="#" class="gallery-link"><i class="fa fa-link fa-2x"></i></a>
                                </div>
                                <div class="gallery-inner">
                                    <a href="#" class="gallery-img"><img src="images/IMG_5430.JPG" class="img-responsive center-block" alt=""/></a>
                                    <a href="#" class="gallery-link"><i class="fa fa-link fa-2x"></i></a>
                                </div>
                            </div>
                        </div>
...
{/* <>
        <div class="paira-container">
            ...
            <section class="top-seller text-center">
                ...
                {/* style="background: url(images/parallax.jpg) no-repeat fixed;" */}
        //         <section class="parallax parallax-height border-bottom" >
        //             <div class="position-r paral">
        //                 <div class="overly"></div>
        //                 <div class="parallax-text">
        //                     <div>
